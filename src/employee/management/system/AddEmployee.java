...
public class AddEmployee extends JFrame implements ActionListener{
	...
	JButton add, back;
	JLabel heading, labelname, labelfname, labeldob, labelsalary, labeladdress, lblempid;
	JLabel labelphone, labelemail, labeleducation, labeldesignation, labeladhaar, labelemployeeid;
	...
	AddEmployee(){
		...
		dedob.setBounds(200, 200, 150, 30);
		add(dedob);
		...
		String courses[] = {"BBA","BCA","BA","B.COM","BSC","B.Tech.","MBA", "MA","M.Tech","MSC","PHD"};
